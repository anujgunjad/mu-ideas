...
<div class="container-fluid py-5" id="mentor">
    <div class="container" style="margin-top: 50px;"data-aos="fade-up">
        <div class="row align-items-center">
            <div class="col-lg-5">
                <img class="img-fluid rounded mb-5 mb-lg-0" src="img/startupclub.jpg" alt="" style="height: 200px; width: 500px;">
            </div>
            <div class="col-lg-7">
...
<i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
              <div id="faq-list-1" class="collapse" data-parent=".faq-list">
                ...
                2.   	It can be commercialized.
                </p>
              </div>
            </li>
            <li data-aos="fade-up" data-aos-delay="200">
              <i class="bx bx-help-circle icon-help"></i> <a data-toggle="collapse" href="#faq-list-2" class="collapsed">Who can apply?
<i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
...
MU Ideas website.
            ...
            <li data-aos="fade-up" data-aos-delay="300">
              <i class="bx bx-help-circle icon-help"></i> <a data-toggle="collapse" href="#faq-list-3" class="collapsed">What is the application deadline?
<i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
              <div id="faq-list-3" class="collapse" data-parent=".faq-list">
                <p>
                20th March 2022 at 11.59PM
                </p>
              </div>
            </li>

            <li data-aos="fade-up" data-aos-delay="400">
              <i class="bx bx-help-circle icon-help"></i> <a data-toggle="collapse" href="#faq-list-4" class="collapsed">Innovations in which sector are eligible to apply?
 <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
              <div id="faq-list-4" class="collapse" data-parent=".faq-list">
                <p>
                All innovations in any sector can apply. (e.g. FinTech, AI/ML, Bio Tech, Nano Tech, IoT etc)
                </p>
              </div>
            </li>

            <li data-aos="fade-up" data-aos-delay="500">
              <i class="bx bx-help-circle icon-help"></i> <a data-toggle="collapse" href="#faq-list-5" class="collapsed">On what parameters would the applicants be screened?
 <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
              <div id="faq-list-5" class="collapse" data-parent=".faq-list">
                <p>
                The applicants will be screened by the Subject Expert Committee (SEC) consisting of IPR, Technical and Business Experts.
                </p>
              </div>
            </li>
...
club of MU Ideas?
 <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
              ...
              ·   	IPR, Quality Testing, Legal and Financial Compliance Support<br/>
              ·   	Connect with leading Angel network and Venture Capital Firms<br/>
              ·   	National and Global Connects<br/>
              ·   	Market and Govt Connect
              </p>
              </div>
            </li>
